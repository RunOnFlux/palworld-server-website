 ...
 * Uses Firebase Authentication (FluxOS pattern)
 */
const GoogleLoginButton = ({ onClose: onSuccess, onLoadingChange, disabled }) => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Signal parent to show connecting state
      onSuccess();
    } catch (error) {
      console.error('Google login failed:', error);

      // Handle all popup cancellation scenarios
